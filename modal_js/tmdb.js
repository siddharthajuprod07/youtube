require([
    ...
    myCustomtable.on("click",function(e){
        ...
        defaultTokenModel.set("clicked_movie_title",e.data["row.title"])
        ...
        $(myModal.$el).on("show", function() {
            ...
            setTimeout(function() {
                ...
                var modal_movie_dtl_srch = new SearchManager({
		            ...
		            preview: true,
		            cache: false,
                    search: "index=\"tmdb_index\" | table id,genre_ids{},original_language,title,original_title,vote_avg,vote_count | where title like \"%$clicked_movie_title$%\"| dedup id" 
                }, {tokens: true});
